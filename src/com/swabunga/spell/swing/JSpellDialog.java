...
public class JSpellDialog extends JDialog implements ActionListener, WindowListener {
	...
	public JSpellDialog(String title, boolean modal) {
		super();
		setTitle(title);
		setModal(modal);
	...
	public static JSpellDialog newJSpellDialog(Container parent, String title, boolean modal) {
		if (parent instanceof Frame) {
			return new JSpellDialog((Frame) parent, title, modal);

		} else if (parent instanceof Dialog) {
			return new JSpellDialog((Dialog) parent, title, modal);

		} else {
			return new JSpellDialog(title, modal);
		}
	}
