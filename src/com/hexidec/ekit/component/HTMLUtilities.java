...
*/
	...
	/** Diese Methode fogt durch String-Manipulation in jtpSource
	...
	/** Diese Methode loscht durch Stringmanipulation in jtpSource das ubergebene Element,
	  * Alternative fur removeElement in ExtendedHTMLDocument, mit closingTag wird angegeben
	...
	public int[] getPositions(Element element, String source, boolean closingTag, String idString)
	{
		...
		if(closingTag)
		{
			...
			// Schleife lauft solange, bis keine neuen StartTags mehr gefunden werden
			...
			do
			{
				...
				// hitUp enthalt die Anzahl der neuen Start-Tags
				if(hitUp == 0)
				{
					end = true;
				}
	...
	/* Diese Methode pruft ob der ubergebene Tag sich in der Hierachie nach oben befindet */
	...
	/* Diese Methoden geben das erste gefundende dem ubergebenen tags entsprechende Element zuruck */
