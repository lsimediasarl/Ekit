...
public class ImageFileDialog extends JDialog implements ActionListener {
	...
	public ImageFileDialog(Frame parent, String imgDir, String[] imgExts, String imgDesc, String imgSrc, String title, boolean bModal) {
		...
		init(imgDir, imgExts, imgDesc, imgSrc);
		
	}

	public ImageFileDialog(Dialog parent, String imgDir, String[] imgExts, String imgDesc, String imgSrc, String title, boolean bModal) {
		super(parent, title, bModal);
	...
	public ImageFileDialog(String imgDir, String[] imgExts, String imgDesc, String imgSrc, String title, boolean bModal) {
		super();
		setTitle(title);
		setModal(bModal);
	...
	public static ImageFileDialog newImageFileDialog(Component parent, String imgDir, String[] imgExts, String imgDesc, String imgSrc, String title, boolean bModal) {
		if (parent instanceof Frame) {
			return new ImageFileDialog((Frame) parent, imgDir, imgExts, imgDesc, imgSrc, title, bModal);
			
		} else if (parent instanceof Dialog) {
			return new ImageFileDialog((Dialog) parent, imgDir, imgExts, imgDesc, imgSrc, title, bModal);
						
		} else {
			return new ImageFileDialog(imgDir, imgExts, imgDesc, imgSrc, title, bModal);
		}
	}
	
	private void init(String imgDir, String[] imgExts, String imgDesc, String imgSrc) {
