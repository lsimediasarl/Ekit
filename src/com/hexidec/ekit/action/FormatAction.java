...
public class FormatAction extends StyledEditorKit.StyledTextAction {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (selText == null || textLength < 1) {
			SimpleInfoDialog sidWarn = SimpleInfoDialog.newSimpleInfoDialog(parentEkit.getParentContainer(), "", true, Translatrix.getTranslationString("ErrorNoTextSelected"), SimpleInfoDialog.ERROR);
		} else {
